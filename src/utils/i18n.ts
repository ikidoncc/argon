...
export const ui = {
  en: {
    ...
    'footer.desc':
      'A personal blog and knowledge repository about technology, science, and lifelong learning.',
  ...
  pt: {
    ...
    'theme.auto': 'Sistema',
    'lang.label': 'Idioma',
    'search.placeholder': 'Digite palavras-chave para buscar...',
    'search.noResults': 'Nenhum resultado encontrado para',
    'footer.desc':
      'Um blog pessoal e repositório de conhecimento sobre tecnologia, ciência e aprendizado contínuo.',
    'footer.built': 'Feito com',
    'footer.hosted': 'Hospedado no',
